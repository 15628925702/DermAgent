...
def load_controller_checkpoint(path: str | Path) -> Tuple[SkillIndex, Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any]]:
    ...
    evidence_calibrator_payload = payload.get("evidence_calibrator", {}) or {}
    return skill_index, controller_payload, final_scorer_payload, rule_scorer_payload, evidence_calibrator_payload
